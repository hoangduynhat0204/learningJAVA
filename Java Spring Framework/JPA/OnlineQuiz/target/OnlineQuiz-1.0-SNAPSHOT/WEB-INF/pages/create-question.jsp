        ...
        <section class="content">
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="body">
                            <form:form action="../question/saveQuestion" cssClass="form-horizontal"
			    ...
			    <form:form path="id" />
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <form:input type="text" id="correct_answer" class="form-control" maxlength="100" path="correct_answer" cssClass="form-control" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <form:input type="text" id="answer_1" class="form-control" maxlength="100" path="answer_1" cssClass="form-control" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <form:input type="text" id="answer_2" class="form-control" maxlength="100" path="answer_2" cssClass="form-control" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <form:input type="text" id="answer_3" class="form-control" maxlength="100" path="answer_3" cssClass="form-control" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
